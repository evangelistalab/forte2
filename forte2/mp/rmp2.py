...
@dataclass
class RMP2(MP2Base):
    """Density-fitted MP2 for an RHF reference.

    Bind the method to an RHF object, call :meth:`run`, and then request
    ...
    def _make_mp2_sf_2rdm(self, t2, gamma1, store_debug=False):
        ...
        if store_debug:
            ...
            # Can also store gamma2_add restricted to OO/OO etc if needed
