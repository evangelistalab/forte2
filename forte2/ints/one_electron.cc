...
namespace forte2 {
nb::ndarray<nb::numpy, double, nb::ndim<2>> overlap(const Basis& b1, const Basis& b2) {
    return compute_one_electron_multi<libint2::Operator::overlap, 1>(b1, b2)[0];
}

nb::ndarray<nb::numpy, double, nb::ndim<2>> kinetic(const Basis& b1, const Basis& b2) {
    return compute_one_electron_multi<libint2::Operator::kinetic, 1>(b1, b2)[0];
}

nb::ndarray<nb::numpy, double, nb::ndim<2>>
nuclear(const Basis& basis1, const Basis& basis2,
...
std::array<nb::ndarray<nb::numpy, double, nb::ndim<2>>, 4>
emultipole1(const Basis& basis1, const Basis& basis2, std::array<double, 3>& origin) {
    return compute_one_electron_multi<libint2::Operator::emultipole1, 4>(basis1, basis2, origin);
}

std::array<nb::ndarray<nb::numpy, double, nb::ndim<2>>, 10>
emultipole2(const Basis& basis1, const Basis& basis2, std::array<double, 3>& origin) {
    return compute_one_electron_multi<libint2::Operator::emultipole2, 10>(basis1, basis2, origin);
}

std::array<nb::ndarray<nb::numpy, double, nb::ndim<2>>, 20>
emultipole3(const Basis& basis1, const Basis& basis2, std::array<double, 3>& origin) {
