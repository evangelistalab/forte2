...
class RelSlaterRules:
    def __init__(self, norb: int, scalar_energy: float, one_electron_integrals: Annotated[ArrayLike, dict(dtype='complex128', shape=(None, None))], two_electron_integrals: Annotated[ArrayLike, dict(dtype='complex128', shape=(None, None, None, None))]) -> None: ...
...
class SparseState:
    ...
    def map(self) -> "ankerl::unordered_dense::v4_5_0::detail::table<forte2::DeterminantImpl<128ul>, std::__1::complex<double>, forte2::BitArray<128ul>::Hash, std::__1::equal_to<forte2::DeterminantImpl<128ul>>, std::__1::allocator<std::__1::pair<forte2::DeterminantImpl<128ul>, std::__1::complex<double>>>, ankerl::unordered_dense::v4_5_0::bucket_type::standard, ankerl::unordered_dense::v4_5_0::detail::default_container_t, false>": ...
