...
np_vector coulomb_3c_deriv(const Basis& b1, const Basis& b2, const Basis& b3, const np_tensor3& W3,
...
np_vector coulomb_2c_deriv(const Basis& b1, const Basis& b2, const np_matrix& W2,
                           const std::vector<std::pair<double, std::array<double, 3>>>& charges) {
    return compute_two_electron_2c_deriv<libint2::Operator::coulomb>(b1, b2, W2, charges);
}

np_vector coulomb_2c_deriv(const Basis& b1, const Basis& b2, const np_matrix_complex& W2,
                           const std::vector<std::pair<double, std::array<double, 3>>>& charges) {
    return compute_two_electron_2c_deriv<libint2::Operator::coulomb>(b1, b2, W2, charges);
}
