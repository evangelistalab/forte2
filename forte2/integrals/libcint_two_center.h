...
DECL_CINT_FUNC_SPH(int1e_ipnuc)
DECL_CINT_FUNC_SPH(int1e_iprinv)
DECL_CINT_FUNC_SPH(int1e_pnucp)
DECL_CINT_FUNC_SPH(int1e_prinvp)
DECL_CINT_FUNC_SPH(int1e_ippnucp)
DECL_CINT_FUNC_SPH(int1e_ipprinvp)
DECL_CINT_FUNC_SPH(int1e_spnucsp)
DECL_CINT_FUNC_SPH(int1e_ipspnucsp)
DECL_CINT_FUNC_SPH(int1e_ipsprinvsp)
...
DECL_CINT_FORTE2_FUNC_SPH(int1e_ipnuc, 3)
DECL_CINT_FORTE2_FUNC_SPH(int1e_iprinv, 3)
DECL_CINT_FORTE2_FUNC_SPH(int1e_pnucp, 1)
DECL_CINT_FORTE2_FUNC_SPH(int1e_prinvp, 1)
DECL_CINT_FORTE2_FUNC_SPH(int1e_ippnucp, 3)
DECL_CINT_FORTE2_FUNC_SPH(int1e_ipprinvp, 3)
DECL_CINT_FORTE2_FUNC_SPH(int1e_spnucsp, 4)
DECL_CINT_FORTE2_FUNC_SPH(int1e_ipspnucsp, 12)
DECL_CINT_FORTE2_FUNC_SPH(int1e_ipsprinvsp, 12)
...
#define DECL_CINT_FORTE2_FUNC_SPINOR(name, comp)                                                   \
    np_tensor3_complex_c cint_##name##_spinor(const std::vector<int>& shell_slice,                 \
                                              np_matrix_int atm, np_matrix_int bas,                \
                                              np_vector env) {                                     \
