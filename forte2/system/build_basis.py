...
def get_atom_basis(basis_per_atom: dict) -> dict:
    ...
    Args:
        basis_per_atom (dict): A dictionary mapping atomic numbers to basis set names.
    Returns:
        dict: The basis set data.
    """
...
def parse_custom_basis_assignment(unique_atoms: set, basis_assignment: dict) -> dict:
    ...
    Args:
        unique_atoms (set): A set of unique atomic numbers in the system.
        basis_assignment (dict): A dictionary mapping atom symbols to basis set names.
    Returns:
