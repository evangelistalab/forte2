...
RelCISigmaBuilder::RelCISigmaBuilder(const CIStrings& lists, double E,
                                     ndarray<std::complex<double>, 2>& H,
                                     ndarray<std::complex<double>, 4>& V, int log_level,
                                     bool use_asym_ints)
...
void RelCISigmaBuilder::set_Hamiltonian(double E, ndarray<std::complex<double>, 2> H,
                                        ndarray<std::complex<double>, 4> V, bool use_asym_ints) {
    E_ = E;
...
void RelCISigmaBuilder::Hamiltonian(ndarray<std::complex<double>, 1> basis,
...
ndarray<std::complex<double>, 1>
RelCISigmaBuilder::form_Hdiag(const std::vector<Determinant>& dets) const {
    auto Hdiag = make_zeros<std::complex<double>, 1>({dets.size()});
