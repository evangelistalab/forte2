...
class CIVector {
  public:
    CIVector(const CIStrings& lists);
    ...
    //     /// @brief return the number of correlated orbitals
    //     size_t norb() const;
    ...
    //     std::vector<size_t> orbpi() const;

    //     /// @brief return the offset array for cmopi
    //     const std::vector<size_t>& orbpi_offset() const;
    ...
    //     double dot(const CIVector& wfn) const;
    ...
    //     static void test_rdms(CIVector& Cl, CIVector& Cr, int max_rdm_level, RDMsType type,
    ...
    //     static std::shared_ptr<RDMs> compute_rdms(CIVector& C_left, CIVector& C_right, int
    //     max_order,
    //                                               RDMsType type);
  ...
  private:
    ...
    //     /// @brief Apply the scalar part of the Hamiltonian to this vector and add it to the
    //     result
    //     /// @param result The wave function to add the result to
    //     /// @param fci_ints The integrals object
    //     void H0(CIVector& result, std::shared_ptr<ActiveSpaceIntegrals> fci_ints);
    ...
    //     /// @param result The wave function to add the result to
    //     /// @param fci_ints The integrals object/
    //     void H2_aabb(CIVector& result, std::shared_ptr<ActiveSpaceIntegrals> fci_ints);
