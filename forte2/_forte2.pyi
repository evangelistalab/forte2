...
@overload
def sparse_operator_hamiltonian(arg0: float, arg1: Annotated[ArrayLike, dict(dtype='float64', shape=(None, None))], arg2: Annotated[ArrayLike, dict(dtype='float64', shape=(None, None, None, None))], arg3: float, /) -> SparseOperator:
    """
    Create a SparseOperator object representing the second quantized Hamiltonian.
    """

@overload
def sparse_operator_hamiltonian(arg0: float, arg1: Annotated[ArrayLike, dict(dtype='complex128', shape=(None, None))], arg2: Annotated[ArrayLike, dict(dtype='complex128', shape=(None, None, None, None))], arg3: float, /) -> SparseOperator: ...
