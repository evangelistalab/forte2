...
@overload
def coulomb_3c_deriv(basis1: Basis, basis2: Basis, basis3: Basis, W3: Annotated[NDArray[numpy.float64], dict(shape=(None, None, None))], charges: Sequence[tuple[float, Sequence[float]]]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,))]: ...

@overload
def coulomb_3c_deriv(basis1: Basis, basis2: Basis, basis3: Basis, W3: Annotated[NDArray[numpy.complex128], dict(shape=(None, None, None))], charges: Sequence[tuple[float, Sequence[float]]]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,))]: ...

@overload
def coulomb_2c_deriv(basis1: Basis, basis2: Basis, W2: Annotated[NDArray[numpy.float64], dict(shape=(None, None))], charges: Sequence[tuple[float, Sequence[float]]]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,))]: ...

@overload
def coulomb_2c_deriv(basis1: Basis, basis2: Basis, W2: Annotated[NDArray[numpy.complex128], dict(shape=(None, None))], charges: Sequence[tuple[float, Sequence[float]]]) -> Annotated[NDArray[numpy.float64], dict(shape=(None,))]: ...
