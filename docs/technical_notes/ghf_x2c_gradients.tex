...
\texttt{forte2/x2c/x2c.py} & X2C Hamiltonian and matrix-valued forward response used as the reference API.\\
\texttt{forte2/x2c/x2c\_grad.py} & Density-contracted reverse X2C response and direct primitive derivative contractions.\\
\bottomrule
\end{tabular}
\end{center}
