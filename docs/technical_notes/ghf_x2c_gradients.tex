...
The implementation covers the following combinations:
\begin{center}
\begin{tabular}{lll}
\toprule
SCF reference & One-electron Hamiltonian & Nuclear model \\
\midrule
RHF, UHF, GHF & nonrelativistic & point or Gaussian \\
RHF, UHF, GHF & spin-free X2C-1e & point or Gaussian \\
GHF & spin-orbit X2C-1e & point or Gaussian \\
GHF & spin-orbit X2C-1e with SNSO & point or Gaussian \\
\bottomrule
\end{tabular}
\end{center}
...
\section{SCF gradient assembly with X2C}
