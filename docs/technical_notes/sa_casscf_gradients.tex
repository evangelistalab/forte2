...
each auxiliary index.  The AO tensor $Z^P_{\mu\nu}$ is released immediately
after this transformation.  Consequently it is not resident when the final
AO-sized three-center weight $W^{P,\alpha}_{\mu\nu}$ is allocated.
