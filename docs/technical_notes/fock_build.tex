\documentclass[notitlepage,pra,aps,preprint]{revtex4-1}
...
\end{quote}
This contraction is cached-friendly since the contraction happens over the outer indices.
...
\end{quote}
These contractions are already cache-friendly since contractions happen over the outer indices.
