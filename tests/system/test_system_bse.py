...
def test_1e_ovlp():
    ...
    assert np.linalg.norm(S) == approx(5.550074629204314)
...
def test_1e_hcore():
    ...
    H = T + V
    assert np.linalg.norm(H) == approx(50.50852825093756)
...
def test_2e_eri():
    ...
    assert np.linalg.norm(eri.flatten()) == approx(20.21663398506663)
