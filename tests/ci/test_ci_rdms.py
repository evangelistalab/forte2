...
def compare_rdms(ci, root):
    ...
    aa_2rdm = ci_solver.ci_sigma_builder.aa_2rdm(ci_vec_det, ci_vec_det)
    ...
    bb_2rdm = ci_solver.ci_sigma_builder.bb_2rdm(ci_vec_det, ci_vec_det)
    ...
    ab_2rdm = ci_solver.ci_sigma_builder.ab_2rdm(ci_vec_det, ci_vec_det)
    ...
    aaa_3rdm = ci_solver.ci_sigma_builder.aaa_3rdm(ci_vec_det, ci_vec_det)
    ...
    bbb_3rdm = ci_solver.ci_sigma_builder.bbb_3rdm(ci_vec_det, ci_vec_det)
    ...
    aab_3rdm = ci_solver.ci_sigma_builder.aab_3rdm(ci_vec_det, ci_vec_det)
    ...
    abb_3rdm = ci_solver.ci_sigma_builder.abb_3rdm(ci_vec_det, ci_vec_det)
