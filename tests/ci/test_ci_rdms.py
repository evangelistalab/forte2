...
def compare_rdms(ci, root):
    ...
    rdm1_a = ci.ci_sigma_builder.rdm1_a(ci_vec_det, ci_vec_det, True)
    rdm1_a_debug = ci.ci_sigma_builder.rdm1_a_debug(ci_vec_det, ci_vec_det, True)
    assert (
    ...
    rdm1_b = ci.ci_sigma_builder.rdm1_a(ci_vec_det, ci_vec_det, False)
    rdm1_b_debug = ci.ci_sigma_builder.rdm1_a_debug(ci_vec_det, ci_vec_det, False)
    assert (
    ...
    rdm1_sf = ci.make_rdm1_sf(ci.evecs[:, root])
    rdm1_sf_debug = ci.ci_sigma_builder.rdm1_sf_debug(ci_vec_det, ci_vec_det)
    assert (
    ...
    rdm2_aa = ci.ci_sigma_builder.rdm2_aa(ci_vec_det, ci_vec_det, True)
    rdm2_aa_debug = ci.ci_sigma_builder.rdm2_aa_debug(ci_vec_det, ci_vec_det, True)
    assert (
    ...
    rdm2_bb = ci.ci_sigma_builder.rdm2_aa(ci_vec_det, ci_vec_det, False)
    rdm2_bb_debug = ci.ci_sigma_builder.rdm2_aa_debug(ci_vec_det, ci_vec_det, False)
    assert (
    ...
    rdm2_ab = ci.ci_sigma_builder.rdm2_ab(ci_vec_det, ci_vec_det)
    rdm2_ab_debug = ci.ci_sigma_builder.rdm2_ab_debug(ci_vec_det, ci_vec_det)
    assert (
    ...
    rdm2_sf = ci.make_rdm2_sf(ci.evecs[:, root])
    rdm2_sf_debug = ci.ci_sigma_builder.rdm2_sf_debug(ci_vec_det, ci_vec_det)
    assert (
    ...
    rdm3_aaa = ci.ci_sigma_builder.rdm3_aaa(ci_vec_det, ci_vec_det, True)
    rdm3_aaa_debug = ci.ci_sigma_builder.rdm3_aaa_debug(ci_vec_det, ci_vec_det, True)
    assert (
    ...
    rdm3_bbb = ci.ci_sigma_builder.rdm3_aaa(ci_vec_det, ci_vec_det, False)
    rdm3_bbb_debug = ci.ci_sigma_builder.rdm3_aaa_debug(ci_vec_det, ci_vec_det, False)
    assert (
    ...
    rdm3_aab = ci.ci_sigma_builder.rdm3_aab(ci_vec_det, ci_vec_det)
    rdm3_aab_debug = ci.ci_sigma_builder.rdm3_aab_debug(ci_vec_det, ci_vec_det)
    assert (
    ...
    rdm3_abb = ci.ci_sigma_builder.rdm3_abb(ci_vec_det, ci_vec_det)
    rdm3_abb_debug = ci.ci_sigma_builder.rdm3_abb_debug(ci_vec_det, ci_vec_det)
    assert (
