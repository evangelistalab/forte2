...
def test_determinant_hilbert_space():
    ...
    dets = hilbert_space(2, 1, 1, nirrep=2, mo_symmetry=[0, 1], symmetry=0)
    # compare with the expected result of the determinant
