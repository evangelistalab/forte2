...
from forte2 import System, RHF, CI, MCOptimizer, State, AVAS, AutoCI
...
C   0.000000   0.651229  -0.499559
    ...
    avas = AVAS(subspace=["C(2p)"], subspace_pi_planes=[["C1-3"]], selection_method="total", num_active=3)(rhf)
    ci = AutoCI(charge=0, multiplicity=1, ms=0.0)(avas)
    mc = MCOptimizer()(ci)
    mc.run()
