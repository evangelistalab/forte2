...
This matters because the ``CI`` driver builds the semicanonical/natural
orbitals in the MOSpace's *contiguous* ordering and then has to permute the
...
def test_dmrg_final_orbitals_natural(tmp_path):
    ...
    g1_act = dmrg.make_average_rdm(1)
